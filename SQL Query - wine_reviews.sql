...
/*	PONIØSZE ZAPYTANIE PRZYGOTOWUJE BAZ  DANYCH RECENZJI WIN Z PORTALU "WINE ENTHUSIAST" ZBIERANYCH DO 2017 ROKU.
	...
	***W LINIJCE 323 NALEØY WPROWADZI∆ åCIEØK  DO PLIKU JSON ZAWIERAJ•CEGO RECENZJE***
	...
	PO PIERWSZYM WPROWADZENIU DANYCH DO TABEL, PROCEDUR  MOZNA POWT”RZY∆ AKTUALIZUJ•C "sp_UpdateData" ZMIENIAJ•C NAZW  PLIKU W LINIJCE 323 NA "winemag-data-130k-V5S",
...
-----------------------------------------------------------------------------------	Procedura wyciπgania danych do tabel wymiarÛw - sp_CreateDimWine
